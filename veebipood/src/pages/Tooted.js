...
function Tooted() {
  // Nobe, Tesla, BMW --- kuvage valja ja tehke mingeid sorteerimisi/filtreerimisi
  ...
  return (
    <div>
      ...
      {tooted.map((toode, index) =>
       <div key={index}>
        <img className={toode.aktiivne ? 'pilt' : 'pilt-mitteaktiivne'} src={toode.pilt} alt='car' />
        <span>{toode.nimi} - {toode.hind} EUR</span>
